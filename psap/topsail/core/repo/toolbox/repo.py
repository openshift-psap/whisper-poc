...
from core.repo.scripts.validate_role_files import main as role_files_main
from core.repo.scripts.validate_role_vars_used import main as role_vars_used_main
import core.repo.scripts.ansible_default_config
import core.repo.scripts.toolbox_rst_documentation

import core.library.ansible_toolbox
...
class Repo:
    ...
    def generate_ansible_default_settings():
        ...
        """
        core.repo.scripts.ansible_default_config.generate_all(core.library.ansible_toolbox.Toolbox())
        exit(0)
    ...
    def send_job_completion_notification(
        ...
        import core.repo.toolbox.notifications.send as send_notif
...
""")
    ...
    def generate_toolbox_rst_documentation():
        ...
        """
        core.repo.scripts.toolbox_rst_documentation.generate_all(core.library.ansible_toolbox.Toolbox())
        exit(0)
